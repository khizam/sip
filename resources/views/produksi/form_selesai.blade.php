<div class="modal fade" id="modal_form_selesai" tabindex="-1" role="dialog" aria-labelledby="modal-form">
                ...
                <div class="row">
                    <div class="col-md-10">
                        <div class="form-group row">
                            <label for="jumlah_hasil_produksi" class="col-md-2 col-md-offset-1 control-label">Jumlah Hasil Produksi</label>
                            <div class="col-md-8">
