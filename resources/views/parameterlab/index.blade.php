...
<div class="box box-default">
    ...
    <div class="box-body">
        <div class="row">
            ...
            @csrf
            @method('post')
                <input type="hidden" name="id_parameterlab" value="{{ request()->route('id_parameterlab') }}">
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Parameter Lab</label>
                        <select class="form-control select2" multiple="multiple" data-placeholder="Pilih Parameter Lab" name="id_parameter" id="id_parameter"
                                style="width: 100%;">
